...
plot(st_geometry(NC_county_means), pch = 20, cex = 1, col = "red", add = TRUE)
```
...
```{r}
plot(st_geometry(NC_counties))
plot(st_geometry(NC_county_medians), pch = 20, cex = 1, col = "red", add = TRUE)
```
